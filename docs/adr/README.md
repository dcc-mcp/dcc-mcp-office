...
| ADR | Title | Status |
|---|---|---|
| [001](001-rust-gateway-csharp-com-sidecar.md) | Rust 网关（既有 dcc-mcp-core）+ C# COM Sidecar | Accepted |
| [002](002-per-app-sidecar-processes.md) | 每个 Office 应用独立 Sidecar 进程 | Accepted |
| [003](003-openxml-plus-com-hybrid.md) | Open XML + COM 混合后端 | Accepted |
